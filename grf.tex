...
\frame{\frametitle{Application to 1$d$ KPZ equation}
...
In this case, for $d=1$ with initial height profile ... the stationary two-point correlation scales as
\begin{align*}
